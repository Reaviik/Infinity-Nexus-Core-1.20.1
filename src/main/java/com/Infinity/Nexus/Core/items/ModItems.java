...
public class ModItems {
    ...
    public static final RegistryObject<Item> ANCESTRAL_COMPONENT = ITEMS.register("ancestral_component", () -> new ComponentItem(new Item.Properties().stacksTo(1).durability(1).rarity(Rarity.EPIC), "1"));
